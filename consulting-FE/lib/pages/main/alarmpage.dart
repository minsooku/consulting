...
import 'package:consulting_fe/pages/sheets/workout_block_sheet.dart';
    ...
    return GestureDetector(
      onTap: hasDetails
          ? block.category == 'workout'
              ? () => WorkoutBlockSheet.show(context, block)
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  Image.asset(imagePath, fit: BoxFit.contain, height: 140),
                  Container(
